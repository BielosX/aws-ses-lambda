...
@Slf4j
public class WelcomeEmailHandler implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent input, Context context) {
        ...
        String decodedBody = new String(Base64.getDecoder().decode(input.getBody()), StandardCharsets.UTF_8);
